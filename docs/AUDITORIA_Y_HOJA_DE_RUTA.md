...
| 6 | CameraX Extensions | ⏳ Pendiente | Siguiente iteración (Night/Bokeh de Samsung). |
...
> Verificación: sin Android SDK en el sandbox, validación estática (firmas de interfaz/impl/fakes, call sites de constructores con argumentos nombrados, longitud de línea, imports). El build real lo hará GitHub Actions al actualizar el PR. Dispositivo objetivo de QA: Galaxy S21 FE (lentes 0.6x/1x/3x, `MANUAL_SENSOR`, RAW, ZSL).
