...
internal object PreferenceKeys {
    ...
    val KEY_COMPOSITION_GRID = stringPreferencesKey("composition_grid")
    val KEY_LEVEL_ENABLED = booleanPreferencesKey("level_enabled")
    val KEY_HISTOGRAM_ENABLED = booleanPreferencesKey("histogram_enabled")
    val KEY_ZEBRAS_ENABLED = booleanPreferencesKey("zebras_enabled")
    val KEY_ZEBRA_THRESHOLD = intPreferencesKey("zebra_threshold_percent")
    val KEY_HAPTICS_ENABLED = booleanPreferencesKey("haptics_enabled")
    val KEY_COACH_ENABLED = booleanPreferencesKey("coach_enabled")
    val KEY_FOCUS_PEAKING_ENABLED = booleanPreferencesKey("focus_peaking_enabled")
    val KEY_TOP_SHOT_ENABLED = booleanPreferencesKey("top_shot_enabled")
    val KEY_CAPTURE_TIMER = stringPreferencesKey("capture_timer")
}
