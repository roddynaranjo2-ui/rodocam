...
include(":core:camera:low-light:low-light-di")
include(":core:camera:low-light-playservices")
include(":core:camera:low-light-playservices-di")
...
include(":core:camera:postprocess:postprocess-di")
include(":core:camera:postprocess:heic")
